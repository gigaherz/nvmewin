NVMe Windows Driver Community Release, December 2014

Description:
This is the release as revision 1.4 from NVMe Windows Driver Community. The release
...
test signed via Visual Studio 2013. You may find more details below.
...
Change Logs:
Revision 1.4 added:
- Migrate to VS 2013/WDK 8.1.
- Support Windows 8.1 and Server 2012 R2.
- WPP Tracing/WMI Processing support.
- Bus reset enhancement.
- Processor hot plug/removal support.
- Format NVM state machine fixes.
- FreeQList access synchronization fix.
- NVMe bus type support.
- WHQL related bug fixes.
- Misc. fixes.

Limitations:
- The driver supports Windows 7/8/8.1, Server 2008 R2/2012/2012 R2.
